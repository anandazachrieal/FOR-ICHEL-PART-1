...
const messages = [
    "Tap dimana aja yaaa",
    "halooooo sayangkuuu cantikkk cintaaa",
    "aku ada mainan buat kamu",
    "coba pencet seng",
    "pencet lagi baby",
    "ayo semangat mencetnya sayangku cantik cinta",
    "liatnya harus happy dan senyum yaaa",
    "karna udah senyum",
    "ini",
    "terakhir",
    "yeyyyy udah pencetan terakhir",
    "apa yaaa selanjutnyaaaa",
    "makasih yaaaa baby udah sama sama aku terus",
    "LOVE YOU SAYANGKU CANTIK CINTA ❤️",
    "hebat kan aku bisa buat ini hihi",
    "coba pencet tombol dibawah ini sayangggg 💝"
];
